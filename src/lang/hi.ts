export const lang = {
    ...
    "NewUpdateTitle": "क्या आपको OTPGRAM पसंद है?",
    ...
    "ExportAccountsText": "आप OTPGRAM का उपयोग करके खातों को लिंक से निर्यात कर सकते हैं, या Google Authenticator (या इसी तरह) में QR कोड का उपयोग कर सकते हैं।",
    ...
    "QRExportDescription": "आप Google Authenticator या OTPGRAM में अपने खातों को QR कोड स्कैन करके आयात कर सकते हैं।",
